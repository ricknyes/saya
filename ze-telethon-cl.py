...
try:
    ...
    api_id = '21993578'
    api_hash = 'a5510e61fc2bf8913c24fcbf952ed80f'
    bot_token = '6822332329:AAGZCdxVBjLTcnLrCqm6ETtOX2U5kN5BBnM'
    DEVLOO = '6367728269'
    MAX_ACCOUNTS = int('2')
    user_bot = 'saya18bot'
...
async def back(event):
        ...
        await event.edit("""**بيدووووو**""", buttons=buttons)
...
async def start(event):
    ...
    if sender.id == DEVELOPER_ID:
        ...
        await bot.send_message(chat, '''**بدبد**''', buttons=buttons)
